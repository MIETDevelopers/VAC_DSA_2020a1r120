...
#     print("cong not eligile")
# else:
#     print("major and eligible")

# wrap program to shows different message depending on wat time of day it is morning, afternoon, evening, or night (time is given in 24 hours format)
...
#wrap to calculate the electricity bill(accept numer from user) acc to the foll criteria
# unit                  price
...
# wrap to calculate the sum of three numebers. if the values are equal return three times their sum..
...
#program to print odd numeber sequence below 'N'
# input: 50
# output:
        # 1
        # 3
